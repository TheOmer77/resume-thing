export const ExampleContent = () => (
  <div className='prose prose-sm prose-slate max-w-none'>
    ...
    <p>
      ...
      styles, but when you <em>really are</em> just trying to style some content
      that came from a rich-text editor in a CMS or a markdown file, it can be
      surprising and unintuitive.
    </p>
    <p>
      We get lots of complaints about it actually, with people regularly asking
      us things like:
    </p>
    <blockquote>
      <p>
    ...
    <p>
      ...
      user-agent styles either &mdash; you want them to look <em>awesome</em>,
      not awful.
    </p>
    <p>
  ...
  <!-- ... -->
    ...
    <p>
      So that&apos;s a header for you &mdash; with any luck if we&apos;ve done
    ...
    <ul>
      <li>
        ...
        <p>
          ...
          honestly, you could make a strong argument that you just
      ...
      <li>
        ...
        <p>
          ...
          want this to look realistic. That&apos;s why I&apos;ve added this
          second list item so I actually have something to look at when writing
          the styles.
        </p>
      </li>
      <li>
  ...
  plugins: [],
      ...
      <li>
        ...
        <ul>
          <li>
            ...
            something but you are just creating a gross shape on the screen that
            is hard to read.
          </li>
          <li>
    ...
    <p>
      Well, that&apos;s not exactly true, we first released this plugin back in
      2020 and it took three years before we added description lists. But
      they&apos;re here now, so let&apos;s just be happy about that…okay? They
      can be great for things like FAQs.
    </p>
    <dl>
    ...
    <p>
      ...
      in your content, Medium only supports two heading levels for a reason, you
      animals. I honestly considered using a <code>before</code> pseudo-element
      to scream at you if you use an <code>h5</code> or <code>h6</code>.
    </p>
    <p>
    ...
    <p>
      ...
      or unbalanced if there is a heading too close to the end of the document.
    </p>
    <p>
