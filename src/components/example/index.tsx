export const ExampleContent = () => (
  <div className='prose prose-sm prose-slate max-w-none'>
    ...
    <p>
      ...
      every time you use a <code>p</code> element in a piece of your dashboard
      UI. And I doubt you really want your blog posts to use the user-agent
      styles either — you want them to look <em>awesome</em>, not awful.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>
        ...
        <p>
          ...
          this to look realistic. That's why I've added this second list item so
...
plugins: [],
    ...
    <p>
      We don't style them at all out of the box because <code>h4</code> elements
      are already so small that they are the same size as the body copy. What
      are we supposed to do with an <code>h5</code>, make it <em>smaller</em>{' '}
